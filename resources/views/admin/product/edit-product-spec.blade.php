                ...
                <div class="card-body">
                    <form action="{{ route('admin.product.specification.update', $productSpecification->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-3">
                            ...
                            <textarea class="form-control" style="resize: none;" id="specific_product_info" name="specific_product_info" rows="2">{{ $productSpecification->specific_product_info }}</textarea>
                        </div>
