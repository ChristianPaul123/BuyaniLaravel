<div class="chat-app">
        ...
        <div class="user-list" wire:ignore>
            @foreach ($users as $user)
                <div wire:key="{{ $user->id }}"
                    ...
                    <img src="{{ $user->profile_pic ? asset($user->profile_pic) : asset('img/title/farmer.png') }}" alt="User Image">
                    <div class="details">
    ...
    <div class="main-chat">
            ...
            @foreach ($messages as $message)
                @if ($message->user_id)
                    ...
                    <div class="message left">
                        ...
                        <img src="{{ $selectedUser->profile_pic ? asset($selectedUser->profile_pic) : asset('img/title/farmer.png') }}" class="user-image" alt="User Image">
        ...
        <div class="input-area">
            <form wire:submit.prevent="sendMessage" id="messageFormFarmer">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Type a message..." wire:model.lazy="messageInput" id="messageInputFarmer" required>
...
<script>
    document.addEventListener('livewire:initialized', function () {
        ...
        const chatBox = document.getElementById('chatBoxFarmer');
