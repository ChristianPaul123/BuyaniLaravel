        ...
        <div class="left-side a w-100">
            ...
            <form class="my-3 a form-part" wire:submit.prevent="login" id="loginForm" autocomplete="off">
                ...
                <div class="form-group d-flex justify-content-end mb-3">
                    ...
                    <a class="clickable-forgot-password" data-bs-toggle="modal" data-bs-target="#modal1"> Forgot Password?</a>
                </div>
            </form>
                        ...
                        <div class="container-contents container-contents-info">
                            ...
                            {{-- <form wire:submit.prevent="requestOtp"> --}}
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email12" wire:model="selectedEmail" class="form-control" placeholder="Enter your email">
                                    @error('selectedEmail') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <button type="submit" class="btn btn-primary mt-3" id="openModal2"  data-bs-toggle="modal" data-bs-target="#modal2">Send OTP</button>
                            {{-- </form> --}}
                        </div>
                    </div>
                </div>
...
<script>
    ...
    document.getElementById("togglePasswordOTP").addEventListener("click", function () {
        ...
        const passwordConfirmationField = document.getElementById("newPasswordConfirmation");
