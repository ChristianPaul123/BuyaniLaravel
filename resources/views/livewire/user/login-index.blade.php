                    ...
                    <div class="container-contents container-contents-info">
                        ...
                        <form wire:submit.prevent="resetPassword">
                            <div class="text-start">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control password1" id="newPassword" wire:model="newPassword" placeholder="Enter your password">
                                ...
                                <input type="password" class="form-control password2" id="newPasswordConfirmation" wire:model="newPassword_confirmation" placeholder="Confirm your password">
