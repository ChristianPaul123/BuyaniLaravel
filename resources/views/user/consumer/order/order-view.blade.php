...
@push('styles')
<style>
    .status-to-standby { background-color: #6c757d; color: white; }
...
<div class="container mt-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <p><strong>Status:</strong>
                <span class="badge {{ 'status-' . strtolower(str_replace(' ', '-', $order->getStatusLabelAttribute())) }}">
    ...
    @endif
     ...
     <div class="d-flex justify-content-end">
        ...
        <!-- Conditional Buttons -->
        @if($order->order_status == 1) <!-- Status: 1 -->
            <a class="btn btn-secondary me-2" href="{{ route('user.consumer.order.cancel', $order->id) }}">Cancel</a>
        @elseif($order->order_status == 2) <!-- Status: 2 -->
        ...
        @elseif($order->order_status == 4) <!-- Status: 4 -->
            <a class="btn btn-success me-2" href="{{ route('user.consumer.order.rate', $order->id) }}">Rate Order</a>
