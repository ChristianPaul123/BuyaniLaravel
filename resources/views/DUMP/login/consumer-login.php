    ...
    if(isset($_POST['submitlogin'])){
        ...
        if(mysqli_num_rows($select_users) > 0){
            ...
            if($row['user_type'] == 'consumer'){
                ...
                $extra = "../landingPage/consumerPage.php";
...
<body style="overflow-x: hidden;">
    ...
    <script>
        ...
        $('#successMessageModal').on('hide.bs.modal', function () {
            window.location.href = "<?php echo isset($_SESSION['redirect_url']) ? $_SESSION['redirect_url'] : '../landingPage/consumerPage.php'; ?>";
        });
